...
function TypeWars () {
  return (
    <div className="project">
      ...
      <a class="waves-effect waves-light btn blue-grey" href="https://www.youtube.com/watch?v=47lKxfCWTo8" target="_blank">Demo</a>
      <a class="waves-effect waves-light btn blue-grey" href="https://github.com/anamsoomro/type_wars" target="_blank">Code</a>
