  ...
  return (
    <div className="summary">
      ...
      <div className="text">
        ...
        <p> Throughout my career I found to be most engaged when confronted with new challenges, hands-on problem solving, working with the team to find the "bugs" in our workflow, and collaboratinig on how to eliminate them. The itch for more is what drew me to programming, but what's kept me hooked has been seeinig things go from 0 to 100.</p>
