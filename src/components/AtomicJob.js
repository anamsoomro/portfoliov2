...
function AtomicJob () {
  return (
    <div className="project">
      ...
      <a class="waves-effect waves-light btn blue-grey" href="https://www.youtube.com/watch?v=5i_m4Tvaw5g&t=5s" target="_blank">Demo </a>
      <a class="waves-effect waves-light btn blue-grey" href="https://github.com/anamsoomro/atomic-job-front-end" target="_blank">Code-Frontend </a> 
      <a class="waves-effect waves-light btn blue-grey" href="https://github.com/anamsoomro/atomic-job-back-end" target="_blank">Code-Backend </a> 
